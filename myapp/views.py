...
from .models import Coupon, Item, OrderItem, Order, Address, Payment, UserProfile, Refund
        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    ...
                    return redirect('myapp:payment', payment_option='paypal')
                else:
                    messages.warning(
...
def get_coupon(request, code):
    try:
        ...
        messages.info(request, "coupon not exist")
        return redirect("myapp:checkout")
